    ...
    <>
          ...
          <div className="project-rail">
            {projects.map((p, i) => (
              <ProjectCard
                ...
                onOpenImage={() => setSelectedImg(p.image || `https://placehold.co/800x450/111118/444455?text=${encodeURIComponent(p.title)}`)}
              />
            ))}
          </div>
        </div>
      ...
      <AnimatePresence>
        {selectedImg && (
          ...
          >
            <button className="proj-lightbox-close" onClick={() => setSelectedImg(null)}>
              <X size={24} />
            </button>
